...
class MateriaSeeder extends Seeder
{
    ...
    public function run()
    {
        $data=[
            ...
            //nuevas materias
            ['descripcion'=>'Aplicación de Sistemas Operativos','departamento'=>'Departamento de Informatica y Sistemas','created_at' => now(),'updated_at' => now()],
            ...
            ['descripcion'=>'Elementos de Programación y Estructura de Datos','departamento'=>'Departamento de Informatica y Sistemas','created_at' => now(),'updated_at' => now()],
            ['descripcion'=>'Elementos de Programación y Estructura de Datos','departamento'=>'Departamento de Informatica y Sistemas','created_at' => now(),'updated_at' => now()],
            ['descripcion'=>'Introduccion a la Programación','departamento'=>'Departamento de Informatica y Sistemas','created_at' => now(),'updated_at' => now()],
            ['descripcion'=>'Taller de Ingenieria de Software','departamento'=>'Departamento de Informatica y Sistemas','created_at' => now(),'updated_at' => now()],
            ...
            ['descripcion'=>'Métodos,Técnicas y Taller de Programación','departamento'=>'Departamento de Informatica y Sistemas','created_at' => now(),'updated_at' => now()],
