...
<?php $__env->startSection('content'); ?>
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="<?php echo e(route('user.store')); ?>" autocomplete="off" class="form-horizontal" name="form">
            <?php echo csrf_field(); ?>
            ...
            <div class="card ">
              <div class="card-header card-header-default bg-dark">
                <h4 class="card-title"><?php echo e(__('Registrar Usuario')); ?></h4>
              ...
              <div class="card-body ">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9">
                      <div class="form-group<?php echo e($errors->has('nombres') ? ' has-danger' : ''); ?>">
                        <input class="form-control<?php echo e($errors->has('nombres') ? ' is-invalid' : ''); ?>" name="nombres" id="id_nombre" type="text" placeholder="<?php echo e(__('Nombres')); ?>" value="<?php echo e(old('nombres')); ?>" required="true" aria-required="true"/>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-5">
                      <div class="form-group<?php echo e($errors->has('ci') ? ' has-danger' : ''); ?>">
                        <input class="form-control<?php echo e($errors->has('ci') ? ' is-invalid' : ''); ?>" name="ci" id="id_ci" type="number" placeholder="<?php echo e(__('Cedula de identidad')); ?>" value="<?php echo e(old('ci')); ?>" required="true" aria-required="true"/>
                        ...
                        <div class="form-group<?php echo e($errors->has('expedido') ? ' has-danger' : ''); ?>">
                            <select name="expedido" class="form-control " style="position: relative;top: -5px;">
                                <?php $__currentLoopData = $expedidos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $expedido): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if( old('expedido')==$expedido->id): ?>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                      <div class="form-group<?php echo e($errors->has('domicilio') ? ' has-danger' : ''); ?>">
                        <input class="form-control<?php echo e($errors->has('domicilio') ? ' is-invalid' : ''); ?>" name="domicilio" id="id_domicilio" type="text" placeholder="<?php echo e(__('Direccion Domicilio')); ?>" value="<?php echo e(old('domicilio')); ?>" />
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                      <div class="form-group<?php echo e($errors->has('celular') ? ' has-danger' : ''); ?>">
                        <input class="form-control<?php echo e($errors->has('celular') ? ' is-invalid' : ''); ?>" name="celular" id="id_celular" type="number" placeholder="<?php echo e(__('Numero de Celular')); ?>" value="<?php echo e(old('celular')); ?>" />
                          ...
                          <div class="row">
                            <div class="px-3 py-2 form-check form-check-radio form-check-inline">
                                <label class="form-check-label">
                                  <input class="form-check-input" type="radio" name="tipo" id="inlineRadio1" value="1" <?php echo e(old('tipo','1')==1?'checked':''); ?>> Estandar
                                  <span class="circle">
                              ...
                              <div class="p-2 form-check form-check-radio form-check-inline">
                                <label class="form-check-label">
                                  <input class="form-check-input" type="radio" name="tipo" id="inlineRadio2" value="2" <?php echo e(old('tipo')==2?'checked':''); ?>> Administrador
                                  <span class="circle">
                                      <span class="check"></span>
                                  </span>
                                </label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                          <div class="form-group<?php echo e($errors->has('email ') ? ' has-danger' : ''); ?>">
                            <input class="form-control<?php echo e($errors->has('email') ? ' is-invalid' : ''); ?>" name="email" id="id_correo" type="email" placeholder="<?php echo e(__('Correo Electronico')); ?>" value="<?php echo e(old('email')); ?>" required/>
                      ...
                      <div class="row">
                          ...
                          <div class="col-sm-9">
                            <div class="form-group<?php echo e($errors->has('password') ? ' has-danger' : ''); ?>">
                              <input class="form-control<?php echo e($errors->has('pass') ? ' is-invalid' : ''); ?>" name="password" id="id_pass" type="password" placeholder="<?php echo e(__('Contraseña')); ?>" value="<?php echo e(old('password')); ?>" required />
                ...
                <div class="text-center" style="background-color:rgb(242, 239, 239);">
                    <br><input type="submit" class="btn btn-dark active btn-lg" value=<?php echo e(__('Registrar')); ?> /><br><br>
                  </div>
            </div>
...
<?php echo $__env->make('layouts.app', ['activePage' => 'user.create', 'titlePage' => __(' Registrar Usuario')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Usuario\Desktop\reserva-aulas\resources\views/users/create.blade.php ENDPATH**/ ?>